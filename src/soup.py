...
theme_toggle = soup.new_tag(
    'button',
    id='theme-toggle',
    string='☀',
)
toggles.append(theme_toggle)
font_toggle = soup.new_tag(
    'button',
    id='font-toggle',
    string='Aa',
)
toggles.append(font_toggle)
...
soup.head.extend([meta_theme_color,'\n'])
